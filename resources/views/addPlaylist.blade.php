        ...
        <div class="row">
            <div class="col-12">
                <form method="post" action="{{url('/playlists/save')}}">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <label class="rdiobox">
                                        <input name="source" type="radio" value="songs" onchange="sourceChanged(this.value)" checked>
                                        <span>Song-Based</span>
                                    </label>
                                </div>
                                <div class="col-12">
                                    <label class="rdiobox">
                                        <input name="source" onchange="sourceChanged(this.value)" type="radio" value="remote_url">
                    ...
                    <div class="card" id="song_based_card" style="display:block;">
                        <div class="card-header">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="custom-switch">
                                            <input type="checkbox" name="avoid_duplicate" class="custom-switch-input" checked>
                                            <span class="custom-switch-indicator"></span>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="custom-switch">
                                            <input type="checkbox" name="on_demand" class="custom-switch-input">
                                            <span class="custom-switch-indicator"></span>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="custom-switch">
                                            <input type="checkbox" name="allow_requests" class="custom-switch-input" checked>
                                            <span class="custom-switch-indicator"></span>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="custom-switch">
                                            <input type="checkbox" name="is_jingle" class="custom-switch-input">
                                            <span class="custom-switch-indicator"></span>
                            ...
                            <div class="row mg-t-15">
                                <div class="col-md-6">
                                    ...
                                    <label class="rdiobox">
                                        <input name="playlist_type" value="default" onchange="songBasedTypeChanged(this.value)" type="radio" checked>
                                    ...
                                    <label class="rdiobox">
                                        <input name="playlist_type" value="once_per_x_songs" onchange="songBasedTypeChanged(this.value)" type="radio">
                                    ...
                                    <label class="rdiobox">
                                        <input name="playlist_type" value="once_per_x_minutes" onchange="songBasedTypeChanged(this.value)" type="radio">
                                    ...
                                    <label class="rdiobox">
                                        <input name="playlist_type" value="once_per_hour" onchange="songBasedTypeChanged(this.value)" type="radio">
                                    ...
                                    <label class="rdiobox">
                                        <input name="playlist_type" value="custom" onchange="songBasedTypeChanged(this.value)" type="radio">
                                        <span>Advanced</span>
                                        <p class="tx-11" style="padding-inline-start: 30px;">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <label class="rdiobox">
                                        <input name="order" type="radio" value="shuffle" checked>
                                        <span>Shuffled</span>
                                        <p class="tx-11" style="padding-inline-start: 30px;">
                                    ...
                                    <label class="rdiobox">
                                        <input name="order" type="radio" value="sequential">
                                ...
                                <div class="col-12 bd mg-t-10 pd-t-10" id="generalRotationCard" style="display:block;">
                                    ...
                                    <div class="form-group select2-sm">
                                        ...
                                        <select name="weight" class="form-select form-select-sm select2 select2-sm select2-no-search" id="inputGroupSelect01">
                                            @for($i = 1; $i <= 25; $i++) <option value="{{$i}}" {{ $i == 3 ? 'selected' : ''}}>{{$i}}</option>
                                                @endfor
                                        </select>
                                ...
                                <div class="col-12 bd mg-t-10 pd-t-10" id="oncePerXSongsCard" style="display:none;">
                                    <span class="tx-18">Once per x Songs</span>
                                    <hr>
                                    <div class="form-group select2-sm">
                                        <label for="play_per_songs">Number of Songs Between Plays</label>
                                        <input type="number" class="form-control" name="play_per_songs" id="play_per_songs" value="0">
                                        <span class="tx-11">This playlist will play every $x songs, where $x is specified here.</span>
                                    </div>
                                </div>

                                <div class="col-12 bd mg-t-10 pd-t-10" id="oncePerXMinutesCard" style="display:none;">
                                    <span class="tx-18">Once per x Minutes</span>
                                    <hr>
                                    <div class="form-group select2-sm">
                                        <label for="play_per_minutes">Number of Minutes Between Plays</label>
                                        <input type="number" class="form-control" name="play_per_minutes" id="play_per_minutes" value="0">
                                        <span class="tx-11">This playlist will play every $x minutes, where $x is specified here.</span>
                                    </div>
                                </div>

                                <div class="col-12 bd mg-t-10 pd-t-10" id="oncePerHourCard" style="display:none;">
                                    <span class="tx-18">Once per Hour</span>
                                    <hr>
                                    <div class="form-group select2-sm">
                                        <label for="play_per_hour_minute">Minute of Hour to Play</label>
                                        <input type="number" class="form-control" name="play_per_hour_minute" id="play_per_hour_minute" value="0" max="60">
                    ...
                    <div class="card" id="remote_url_card" style="display:none;">
                        <div class="card-header">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="remote_url" value="">
                                    </div>
                                    <div class="form-group">
                                        <label for="remote_url">Remote Playback Buffer (Seconds)</label>
                                        <input type="number" value="0" class="form-control" name="remote_buffer">
                                        <span class="tx-11">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <label class="rdiobox">
                                        <input name="remote_type" value="stream" type="radio" checked>
                                        <span>Icecast/Shoutcast Stream URL</span>
                                    </label>
                                    <label class="rdiobox">
                                        <input name="remote_type" value="playlist" type="radio">
                                        <span>Playlist (M3U/PLS) URL</span>
                                    </label>
                                    <label class="rdiobox">
                                        <input name="remote_type" value="other" type="radio">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="checkbox">
                                        <div class="custom-checkbox custom-control">
                                            <input type="checkbox" name="interrupt" data-checkboxes="mygroup" class="custom-control-input" id="interrupt">
                                    ...
                                    <div class="checkbox">
                                        <div class="custom-checkbox custom-control">
                                            <input type="checkbox" name="single_track" data-checkboxes="mygroup" class="custom-control-input" id="single_track">
                                            <label for="single_track" class="custom-control-label mt-1">Only play one track at scheduled time.</label>
                                        </div>
                                    </div>
                                    <div class="checkbox">
                                        <div class="custom-checkbox custom-control">
                                            <input type="checkbox" name="merge" data-checkboxes="mygroup" class="custom-control-input" id="merge">
